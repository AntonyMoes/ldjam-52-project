...
namespace _Game.Scripts {
    public class TutorialController : MonoBehaviour {
        ...
        [SerializeField] private TutorialStep[] _level2steps;
        ...
        public void StartLevel1Tutorial(Action onDone = null) {
            StartTutorial(_steps, onDone);
        }

        public void StartLevel2Tutorial(Action onDone = null) {
            StartTutorial(_level2steps, onDone);
        }
        ...
        private static void SetPositionSettings(RectTransform textTransform, TextPosition position) {
            ...
            bool Has(TextPosition component) => (position & component) == component;
